...
<table><thead><tr><th><strong>微服务技术条目</strong></th><th>落地技术</th></tr></thead><tbody><tr><td>服务开发</td><td>SpringBoot、Spring、SpringMVC等</td></tr><tr><td>服务配置与管理</td><td>Netfix公司的Archaius、阿里的Diamond等</td></tr><tr><td>服务注册与发现</td><td>Eureka、Consul、Zookeeper等</td></tr><tr><td>服务调用</td><td>Rest、PRC、gRPC</td></tr><tr><td>服务熔断器</td><td>Hystrix、Envoy等</td></tr><tr><td>负载均衡</td><td>Ribbon、Nginx等</td></tr><tr><td>服务接口调用(客户端调用服务的简化工具)</td><td>Fegin等</td></tr><tr><td>消息队列</td><td>Kafka、RabbitMQ、ActiveMQ等</td></tr><tr><td>服务配置中心管理</td><td>SpringCloudConfig、Chef等</td></tr><tr><td>服务路由(API网关)</td><td>Zuul等</td></tr><tr><td>服务监控</td><td>Zabbix、Nagios、Metrics、Specatator等</td></tr><tr><td>全链路追踪</td><td>Zipkin、Brave、Dapper等</td></tr><tr><td>数据流操作开发包</td><td>SpringCloud Stream(封装与Redis，Rabbit，Kafka等发送接收消息)</td></tr><tr><td>时间消息总栈</td><td>SpringCloud Bus</td></tr><tr><td>服务部署</td><td>Docker、OpenStack、Kubernetes等</td></tr></tbody></table>
...
![在这里插入图片描述](./images/70_bhdfvbjknkjlfb.png)
...
![在这里插入图片描述](./images/70-174878026319212.png)
...
![在这里插入图片描述](./images/70-1748780470724127.png)
...
![在这里插入图片描述](./images/70-174878027141517.png)
...
![在这里插入图片描述](./images/70-174878027342920.png)
...
![在这里插入图片描述](./images/70-174878027737323.png)
...
1.  修改Eureka上的默认描述信息
    ...
    结果如图：  
    ![在这里插入图片描述](./images/70-174878028080126.png)
    
    如果此时停掉springcloud-provider-dept-8001 等30s后 监控会开启保护机制  
    ![在这里插入图片描述](./images/70-174878028656829.png)
    
2.  配置关于服务加载的监控信息
    

![在这里插入图片描述](./images/70-174878028912532.png)
...
![在这里插入图片描述](./images/70-174878030674239.png)
...
![在这里插入图片描述](./images/70-1748780480067130.png)
...
![在这里插入图片描述](./images/70-174878031509944.png)

在hosts文件最后加上，要访问的本机名称，默认是localhost

![在这里插入图片描述](./images/70-174878031743947.png)
...
![在这里插入图片描述](./images/70-174878032738952.png)
...
![在这里插入图片描述](./images/70-174878033194155.png)
...
![在这里插入图片描述](./images/70-174878033491558.png)
...
![在这里插入图片描述](./images/70-174878036029873.png)
...
![在这里插入图片描述](./images/70-174878036679976.png)

prefer-ip-address: true：

![在这里插入图片描述](./images/70-174878036889779.png)
...
![在这里插入图片描述](./images/70-174878037497684.png)
...
![在这里插入图片描述](./images/70-174878038026787.png)
...
![在这里插入图片描述](./images/70-174878039019392.png)
...
![在这里插入图片描述](./images/70-174878039471195.png)
...
![在这里插入图片描述](./images/70-1748780418553115.png)

![在这里插入图片描述](./images/70-1748780420551118.png)
...
![在这里插入图片描述](./images/70-1748780425530121.png)  
第二部：启动ConfigEurekaServer_7001，访问 http://localhost:7001/ 测试

![在这里插入图片描述](./images/70-1748780428109124.png)  
显示上图则成功
