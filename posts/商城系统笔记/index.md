...
| 管理员登录                                |
| ----------------------------------------- |
| ![1610442011156.png](./images/1610442011156.png) |

##### 2.2.2 类别管理业务流程

| 添加类别                                  |
| ----------------------------------------- |
| ![1610443063398.png](./images/1610443063398.png) |

| 类别列表                                  |
| ----------------------------------------- |
| ![1610499588468.png](./images/1610499588468.png) |

| 修改类别                                  |
| ----------------------------------------- |
| ![1610501150920.png](./images/1610501150920.png) |

| 删除类别                                  |
| ----------------------------------------- |
| ![1610501789493.png](./images/1610501789493.png) |

##### 2.2.3 商品管理业务流程

| 发布商品                                  |
| ----------------------------------------- |
| ![1610677841684.png](./images/1610677841684.png) |
...
![1610443666213.png](./images/1610443666213.png)

![1610443710592.png](./images/1610443710592.png)

##### 3.1.2 IDEA启动tomcat

| 启动                                      |
| ----------------------------------------- |
| ![1610523339517.png](./images/1610523339517.png) |

**如果在启动Tomcat时出现以下错误，请手动打开Tomcat/bin/tomcat8w.exe关闭之前运行的Tomcat**

![1610523020670.png](./images/1610523020670.png)
...
|                                           |
| ----------------------------------------- |
| ![1610523582882.png](./images/1610523582882.png) |
| ![1610523659284.png](./images/1610523659284.png) |
...
| web/WEB-INF/web.xml                       |
| ----------------------------------------- |
| ![1610524292794.png](./images/1610524292794.png) |
...
| 目录结构                                  |
| ----------------------------------------- |
| ![1610524617669.png](./images/1610524617669.png) |
...
- 在`cn.edu.hubu.xmsc.utils`包装创建`DBUtil`类
  ...
  | DBUtil                                    |
  | ----------------------------------------- |
  | ![1610525237922.png](./images/1610525237922.png) |
  | ![1610525261726.png](./images/1610525261726.png) |
...
- DTO类
  ...
  | Manager                                   |
  | ----------------------------------------- |
  | ![1610525517891.png](./images/1610525517891.png) |

- DAO类

  | ManagerDAO                                |
  | ----------------------------------------- |
  | ![1610526283255.png](./images/1610526283255.png) |
...
- DTO类
  ...
  | Type                                      |
  | ----------------------------------------- |
  | ![1610527450867.png](./images/1610527450867.png) |

- DAO类

  | TypeDAO                                   |
  | ----------------------------------------- |
  | ![1610528636872.png](./images/1610528636872.png) |
...
>
>   ![1610530081453.png](./images/1610530081453.png)
>
...
| Servlet类的创建步骤                       |
| ----------------------------------------- |
| ![1610587012252.png](./images/1610587012252.png) |

###### 4.1.2 login.jsp提交数据到LoginServlet类

| login.jsp                                 |
| ----------------------------------------- |
| ![1610587524497.png](./images/1610587524497.png) |

###### 4.1.3 在LoginServlet类接收并处理请求

| LoginServlet                              |
| ----------------------------------------- |
| ![1610591013522.png](./images/1610591013522.png) |

###### 4.1.4 在login.jsp显示提示信息

| login.jsp                                 |
| ----------------------------------------- |
| ![1610591138468.png](./images/1610591138468.png) |

###### 4.1.5 使用session解决登录认证问题

> 登录认证问题：如果管理员没有，我们不允许浏览器访问处理login.jsp以外的任何页面
>
> ![1610592349346.png](./images/1610592349346.png)

| index.jsp                                 |
| ----------------------------------------- |
| ![1610592637201.png](./images/1610592637201.png) |

| LoginServlet                              |
| ----------------------------------------- |
| ![1610592811633.png](./images/1610592811633.png) |
...
| index.jsp                                 |
| ----------------------------------------- |
| ![1610593336210.png](./images/1610593336210.png) |
...
| index.jsp                                 |
| ----------------------------------------- |
| ![1610594673710.png](./images/1610594673710.png) |

###### 4.2.2 创建TypeAddServlet

| TypeAddServlet                            |
| ----------------------------------------- |
| ![1610594884650.png](./images/1610594884650.png) |

###### 4.2.3 type-add.jsp提交类别信息到TypeAddServlet

| type-add.jsp                              |
| ----------------------------------------- |
| ![1610595016332.png](./images/1610595016332.png) |

###### 4.2.4 在TypeAddServlet中接收并保存类信息，并跳转到提示页面

| TypeAddServlet                            |
| ----------------------------------------- |
| ![1610595527075.png](./images/1610595527075.png) |
...
| tips.jsp                                  |
| ----------------------------------------- |
| ![1610596793639.png](./images/1610596793639.png) |

###### 4.2.6 类别数据校验

| type-add.jsp                              |
| ----------------------------------------- |
| ![1610675320038.png](./images/1610675320038.png) |
| ![1610675401594.png](./images/1610675401594.png) |
...
| TypeListServlet                           |
| ----------------------------------------- |
| ![1610604929345.png](./images/1610604929345.png) |

###### 4.3.2 在index.jsp点击`类别列表`跳转到TypeListServlet

| index.jsp                                 |
| ----------------------------------------- |
| ![1610605023082.png](./images/1610605023082.png) |

###### 4.3.3 在TypeListServlet中查询所有类别并传递到type-list.jsp

| TypeListServlet                           |
| ----------------------------------------- |
| ![1610605323655.png](./images/1610605323655.png) |
...
| type-list.jsp                             |
| ----------------------------------------- |
| ![1610606044153.png](./images/1610606044153.png) |
...
| TypeQueryServlet                          |
| ----------------------------------------- |
| ![1610606520243.png](./images/1610606520243.png) |

###### 4.4.2 点击type-list.jsp页面的`修改`将类别ID传递到TypeQueryServlet

| type-list.jsp                             |
| ----------------------------------------- |
| ![1610607061493.png](./images/1610607061493.png) |

###### 4.4.3 在TypeQueryServlet接收类别ID、查询并传递到type-modify.jsp

| TypeQueryServlet                          |
| ----------------------------------------- |
| ![1610607434391.png](./images/1610607434391.png) |

###### 4.4.4 在type-modify.jsp显示类别的原始信息

| type-modify.jsp                           |
| ----------------------------------------- |
| ![1610607955058.png](./images/1610607955058.png) |
...
| type-modify.jsp                           |
| ----------------------------------------- |
| ![1610608556742.png](./images/1610608556742.png) |

###### 4.4.7 在TypeUpdateServlet接收类别信息并执行修改

| TypeUpdateServlet                         |
| ----------------------------------------- |
| ![1610673044403.png](./images/1610673044403.png) |
...
| type-list.jsp                             |
| ----------------------------------------- |
| ![1610672684600.png](./images/1610672684600.png) |

###### 4.5.3 在TypeDeleteServlet中接收类别ID并执行删除

| TypeDeleteServlet                         |
| ----------------------------------------- |
| ![1610673567623.png](./images/1610673567623.png) |

###### 4.5.4 当点击“删除”之后弹出弹窗确认

| type-list.jsp                             |
| ----------------------------------------- |
| ![1610673640358.png](./images/1610673640358.png) |

#### 4.6 商品管理—发布商品

![1610677868219.png](./images/1610677868219.png)
...
- 创建DTO类
  ...
  | Goods                                     |
  | ----------------------------------------- |
  | ![1610679631539.png](./images/1610679631539.png) |

- 创建DAO类

  | GoodsDAO                                  |
  | ----------------------------------------- |
  | ![1610680057416.png](./images/1610680057416.png) |
...
| index.jsp                                 |
| ----------------------------------------- |
| ![1610681185646.png](./images/1610681185646.png) |

###### 4.6.5. 在GoodsListTypeServlet类中查询类别列表传递到goods-add.jsp

| GoodsListTypeServlet                      |
| ----------------------------------------- |
| ![1610681358595.png](./images/1610681358595.png) |

###### 4.6.6 在goods-add.jsp中通过JSTL显示类别信息到下拉菜单选项

| goods-add.jsp                             |
| ----------------------------------------- |
| ![1610681638022.png](./images/1610681638022.png) |
...
| goods-add.jsp                             |
| ----------------------------------------- |
| ![1610682415839.png](./images/1610682415839.png) |
...
| GoodsAddServlet                           |
| ----------------------------------------- |
| ![1610683448456.png](./images/1610683448456.png) |
| ![1610694609894.png](./images/1610694609894.png) |
| ![1610694643764.png](./images/1610694643764.png) |

#### 4.7 商品管理—商品列表

![1610697617245.png](./images/1610697617245.png)
...
| GoodsDAO                                  |
| ----------------------------------------- |
| ![1610698900572.png](./images/1610698900572.png) |
| ![1610699013847.png](./images/1610699013847.png) |
...
| index.jsp                                 |
| ----------------------------------------- |
| ![1610700106378.png](./images/1610700106378.png) |

###### 4.7.5 在GoodsListServlet类中接收页码、查询数据

| GoodsListServlet                          |
| ----------------------------------------- |
| ![1610700741984.png](./images/1610700741984.png) |

###### 4.7.6 在goods-list.jsp中通过JSTL显示商品信息、分页信息

| goods-list.jsp     显示商品数据           |
| ----------------------------------------- |
| ![1610701545034.png](./images/1610701545034.png) |

| goods-list.jsp   显示分页数据             |
| ----------------------------------------- |
| ![1610702700144.png](./images/1610702700144.png) |

#### 4.8 商品管理—搜索—按类别搜索

![1610758976368.png](./images/1610758976368.png)

###### 4.8.1 完成按类别查询商品的数据库操作

| GoodsDAO                                  |
| ----------------------------------------- |
| ![1610759807858.png](./images/1610759807858.png) |

###### 4.8.2 在GoodsListServlet中查询所有类别，并传递到goods-list.jsp

| **GoodsListServlet**                      |
| ----------------------------------------- |
| ![1610760088589.png](./images/1610760088589.png) |

###### 4.8.3 在商品列表页面显示类别列表

| goods-list.jsp                            |
| ----------------------------------------- |
| ![1610760363222.png](./images/1610760363222.png) |
...
| goods-list.jsp                            |
| ----------------------------------------- |
| ![1610760672833.png](./images/1610760672833.png) |

###### 4.8.6 在GoodsListByTypeServlet中接收类别ID和页码进行查询

| GoodsListByTypeServlet                    |
| ----------------------------------------- |
| ![1610761241234.png](./images/1610761241234.png) |

###### 4.8.9 按类别查询商品分页问题

| GoodsListServlet                          |
| ----------------------------------------- |
| ![1610763033370.png](./images/1610763033370.png) |

| GoodsListByTypeServlet                    |
| ----------------------------------------- |
| ![1610763056810.png](./images/1610763056810.png) |

| goods-list.jsp                            |
| ----------------------------------------- |
| ![1610763127797.png](./images/1610763127797.png) |
| ![1610763174044.png](./images/1610763174044.png) |
...
- 进入到ECS服务器管理界面
  ...
  ![1610766109066.png](./images/1610766109066.png)

- 点击购买的实例进入到实例的配置页面

  ![1610766189956.png](./images/1610766189956.png)

###### 5.3.2 云主机系统管理

- 常规配置

  ![1610766335536.png](./images/1610766335536.png)

###### 5.3.3 修改云主机密码

- 设置root用户的登录密码

  ![1610766513247.png](./images/1610766513247.png)

- 密码重置完成之后，重启服务器

  ![1610766572092.png](./images/1610766572092.png)
...
- 进入到安全组配置页面
  ...
  ![1610766840295.png](./images/1610766840295.png)

- 放行 3306端口

  ![1610767007831.png](./images/1610767007831.png)

- 放行8080端口

  ![1610767094433.png](./images/1610767094433.png)
...
- 创建连接
  ...
  ![1610767640965.png](./images/1610767640965.png)

- 将Tomcat和JDK的安装包 上传到 Linux

  ![1610767811153.png](./images/1610767811153.png)
...
- 如果xftp已经与云主机建立连接，xshell其实是可以不用建立连接的，建议在xshell创建连接
  ...
  ![1610768173210.png](./images/1610768173210.png)
...
![1610769015678.png](./images/1610769015678.png)

- 编辑这个profile文件，在文件中添加JDK环境变量

> [root@theo etc]# vim profile  可以打开文件编辑器，必须输入字母i进入到编辑状态,在最后面添加如下四项配置：![1610769616142.png](./images/1610769616142.png)
...
| ----------------------------------------- |
| ![1610777918268.png](./images/1610777918268.png) |
...
![1610781176254.png](./images/1610781176254.png)
